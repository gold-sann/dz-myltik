...
int drow_stive (double x, double y);
...
int drow_cat (double x, double y, double size_x, double size_y, double slide_leg, double slide_y,  double slide_yxa, double slide_nos_y, double slide_nos_x, double slide_leg_ggo)
    ...
    // задн€€ нога 2
    txSetColor (TX_LIGHTRED, 3); txLine ((134 - 300) * size_x + x, (345 - 280) * size_y + y, (56  - 300 - slide_leg) * size_x + x, (400 - 280 - slide_y) * size_y + y);
    txSetColor (TX_WHITE, 3); txLine ((56  - 300 - slide_leg) * size_x + x, (400 - 280 - slide_y) * size_y + y, (30  - 300 - slide_leg) * size_x + x, (407 - 280 - slide_y) * size_y + y);
...
int drow_stive (double x, double y)
    {
    txLine (-15 + x, -122 + y, 204 + x, -34 + y); //рука
    txLine (204 + x, -34 + y, 188 + x, -34 + y);
    txLine (192 + x, -30 + y, -36 + x, -120 + y);
    txLine (-36 + x, -120 + y, -64 + x, -46 + y);
    txLine (-64 + x, -46 + y, 160 + x, 49 + y);
    txLine (160 + x, 49 + y, 177 + x, 42 + y);
    txLine (177 + x, 42 + y, 205 + x, -32 + y);
    txLine (190 + x, -29 + y, 163 + x, 49 + y);

    txLine (50 + x, -95 + y, 60 + x, 96 + y); //туловеще
    txLine (60 + x, 96 + y, -62 + x, 109 + y);
    txLine (-62 + x, 109 + y, -63 + x, -95 + y);
    txLine (-63 + x, -95 + y, 50 + x, -95 + y);
    txLine (12 + x, 108 + y, 12 + x, -70 + y);
    txLine (9 + x, 108 + y, -64 + x, 108 + y);
    txCircle(400, 270, 10 + y);

    //txLine (412, 380, 388, 380 + y);
    //txLine (388, 380, 388, 193 + y);
    //txLine (388, 193, 347, 191 + y);

    txLine (-63 + x, 109 + y, -61 + x, 375 + y); //ноги
    txLine (-61 + x, 375 + y, 18 + x, 377 + y);
    txLine (11 + x, 107 + y, 11 + x, 113 + y);
    txLine (11 + x, 113 + y, 30 + x, 113 + y);
    txLine (30 + x, 113 + y, 31 + x, 362 + y);
    txLine (31 + x, 362 + y, 49 + x, 343 + y);
    txLine (49 + x, 343 + y, 49 + x, 95 + y);
    txLine (49 + x, 95 + y, 11 + x, 111 + y);
    txLine (11 + x, 111 + y, -63 + x, 109 + y);
